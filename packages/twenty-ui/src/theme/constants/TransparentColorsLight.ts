...
export const TRANSPARENT_COLORS_LIGHT = {
  ...
  blue1: RadixColors.skyA.skyA1,
  blue2: RadixColors.skyA.skyA2,
  blue3: RadixColors.skyA.skyA3,
  blue4: RadixColors.skyA.skyA4,
  blue5: RadixColors.skyA.skyA5,
  blue6: RadixColors.skyA.skyA6,
  blue7: RadixColors.skyA.skyA7,
  blue8: RadixColors.skyA.skyA8,
  blue9: RadixColors.skyA.skyA9,
  blue10: RadixColors.skyA.skyA10,
  blue11: RadixColors.skyA.skyA11,
  blue12: RadixColors.skyA.skyA12,
